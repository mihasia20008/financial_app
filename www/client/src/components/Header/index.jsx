...
const Header = ({title, menuIsOpen, toggleMenu, toggleSortForm, toggleFilterForm}) => {
    return (
        <div className="header">
            ...
            <button className="header__button header__button--float" type="button" onClick={toggleSortForm}>
                <svg className="header__button-icon">
                    <use xlinkHref="#sort-icon" />
                </svg>
            </button>
            <button className="header__button" type="button" onClick={toggleFilterForm}>
                <svg className="header__button-icon">
